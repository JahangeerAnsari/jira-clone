...
const statusColorMap: Record<TaskStatus, string> = {
    ...
    [TaskStatus.PR_REVIEW]:"border-l-blue-500",
    ...
    return (
      <div className="px-2">
        <div
          ...
          className={cn(
            "p-1.5 text-xs bg-white text-primary border rounder-md border-l-4 flex flex-col gap-y-1,5 cursor-pointer hover:opacity-75 transition",
